...
namespace BBUnity.Conditions
{
    ...
    /// </summary>
    [Condition("Perception/CustomIsPlayerClose")]
    [Help("Checks whether a target is close depending on a given distance")]
    public class CustomIsPlayerClose : GOCondition
    {
        ...
        {
            return (gameObject.transform.position - GameObject.FindGameObjectWithTag("Player").GetComponent<FirstPersonController>().transform.position).sqrMagnitude < closeDistance * closeDistance;
        }
    }
}